...
% Overview
\begin{frame}{This Week's Journey 🗺️}
    \begin{columns}[T]
...
\begin{frame}{Data Cleaning \& Preprocessing 📝}
...
\begin{frame}{Tokenization: Breaking Text into Pieces 🔤}
...
\begin{frame}{Visual: How "unhappiness" Gets Tokenized 📊}
    \begin{center}
        \begin{tikzpicture}[scale=0.9]
            ...
            \node[anchor=west, font=\small] at (2,3) {1 token};
            ...
            \node[anchor=west, font=\small] at (2.2,1.5) {2 tokens};
            ...
            \node[anchor=west, font=\small] at (1.2,0) {11 tokens};
        \end{tikzpicture}
    \end{center}
...
\begin{frame}{Syntactic Dependencies in Neural Networks 🧠}
...
\begin{frame}{Statistical Learning in Infants 👶}
...
\begin{frame}{Statistical Regularities: The Numbers 📊}
    ...
    \begin{center}
        \begin{tikzpicture}[scale=0.9]
            ...
            \draw[->, thick, color=darkgreen] (0.4,2) -- (1.1,2) node[midway,above,font=\small] {1.0};
            \draw[->, thick, color=darkgreen] (1.9,2) -- (2.6,2) node[midway,above,font=\small] {1.0};
            ...
            \draw[->, thick, color=orange] (0.4,0.5) -- (1.1,0.5) node[midway,above,font=\small] {0.33};
...
\begin{frame}{Connecting Infants to NLP 🔄}
    \begin{columns}[T]
...
\begin{frame}{From Statistical Learning to Modern Tokenization 🔍}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            % Arrow
            \draw[->, thick, dashed] (0,2.2) -- (0,1.3) node[midway,right,font=\small] {similar principle};
...
% Practical Exercises
\begin{frame}{Hands-On Practice 🛠️}
...
\begin{frame}{Assignment 2: Getting Started 🚀}
...
\begin{frame}{Looking Ahead: Week 3-4 🔮}
    \textbf{Next topics:}
    \begin{itemize}
