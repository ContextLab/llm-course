...
\begin{frame}[shrink=5]{The Data Cleaning Pipeline 🔄}
    \begin{center}
...
% Web Scraping
\begin{frame}[shrink=10]{Collecting Data: Web Scraping 🌐}
...
\begin{frame}[shrink=10]{Handling Text Encodings 🔤}
...
\begin{frame}[shrink=10]{Reducing Words to Base Forms 🌱}
...
\begin{frame}[shrink=10]{Stop Words Removal 🛑}
...
\begin{frame}[shrink=10]{Discussion: Preprocessing Trade-offs 🤔}
...
% Practical Tips
\begin{frame}[shrink=10]{Practical Tips for Data Cleaning 💡}
    \textbf{Best practices:}
...
\begin{frame}[shrink=10]{Preprocessing Checklist ✅}
...
% Resources
\begin{frame}[shrink=10]{Tools and Libraries 🛠️}
    \textbf{Web Scraping:}
    \begin{itemize}\setlength{\itemsep}{0pt}
