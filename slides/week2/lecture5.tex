...
\begin{frame}[shrink=5]{The Tokenization Spectrum 📊}
    \begin{center}
        \begin{tikzpicture}[scale=0.9]
            ...
            \node[above, color=darkgreen, font=\footnotesize\bfseries] at (6,1.8) {Sweet Spot! ✨};
        \end{tikzpicture}
    \end{center}
...
\begin{frame}[shrink=10]{Why Not Just Split on Spaces? 🤔}
...
\begin{frame}[shrink=5]{Word-level Limitations Illustrated 📉}
    \begin{center}
        \begin{tikzpicture}[scale=0.85]
            ...
            \node[color=lightblue, font=\footnotesize] at (7,4) {Word-level 📈};

            % Subword curve (logarithmic)
            \draw[thick, color=orange, domain=0:9] plot (\x, {1.5*ln(\x+1)});
            \node[color=orange, font=\footnotesize] at (7,2.5) {Subword-level 📊};

            % Character curve (flat)
            \draw[thick, color=purple, domain=0:9] plot (\x, {0.5});
            \node[color=purple, font=\footnotesize] at (7,0.8) {Character-level →};
...
\begin{frame}[shrink=10]{The Solution: Subword Tokenization 🎯}
...
\begin{frame}[shrink=5]{Visual: How "unhappiness" Gets Tokenized 📊}
    \begin{center}
        \begin{tikzpicture}[scale=0.9]
            ...
            \node[anchor=west, font=\footnotesize] at (2,3.5) {1 token};
            ...
            \node[anchor=west, font=\footnotesize] at (2.2,2) {2 tokens};

            % Alternative BPE
            \node[rectangle, draw, fill=orange!20, minimum width=1.2cm, minimum height=0.8cm, font=\footnotesize] at (-1.5,0.8) {\texttt{un}};
            \node[rectangle, draw, fill=orange!20, minimum width=1cm, minimum height=0.8cm, font=\footnotesize] at (-0.3,0.8) {\texttt{happ}};
            \node[rectangle, draw, fill=orange!20, minimum width=0.8cm, minimum height=0.8cm, font=\footnotesize] at (0.7,0.8) {\texttt{i}};
            \node[rectangle, draw, fill=orange!20, minimum width=1cm, minimum height=0.8cm, font=\footnotesize] at (1.7,0.8) {\texttt{ness}};
            \node[anchor=east, font=\footnotesize] at (-2.5,0.8) {Alternative:};
            \node[anchor=west, font=\footnotesize] at (2.5,0.8) {4 tokens};
            ...
            \node[anchor=west, font=\footnotesize] at (1.2,-0.5) {11 tokens};
        \end{tikzpicture}
    \end{center}
...
\begin{frame}[shrink=10]{BPE Example: Step by Step 👣}
...
\begin{frame}[shrink=5]{BPE Visualization 🎨}
    \begin{center}
        \begin{tikzpicture}[scale=0.85][
            ...
            % Step 0: Characters
            \node[font=\footnotesize] at (-1,3) {Step 0:};
            \node[token] at (0,3) {l};
            ...
            % Step 1: Merge e+s
            \node[font=\footnotesize] at (-1,2) {Step 1:};
            \node[token] at (0,2) {l};
            ...
            % Step 2: Merge es+t
            \node[font=\footnotesize] at (-1,1) {Step 2:};
            \node[token] at (0,1) {l};
            ...
            % Step 3: Merge l+o
            \node[font=\footnotesize] at (-1,0) {Step 3:};
...
% SentencePiece
\begin{frame}[shrink=10]{SentencePiece: Language-Agnostic Tokenization 🌍}
...
\begin{frame}[shrink=10]{Vocabulary Size Trade-offs 🎚️}
...
\begin{frame}[shrink=10]{Tokenization Pitfalls and Gotchas ⚠️}
...
\begin{frame}[shrink=10]{Connection to Human Language Learning 👶}
...
\begin{frame}[shrink=10]{Statistical Learning in Action 📊}
    \begin{columns}[T]
