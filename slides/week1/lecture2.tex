...
\begin{frame}{Regex State Machine Visualization 🔧}
\begin{center}
...
\begin{frame}{The Substitution Pipeline 🔧}
\begin{center}
\begin{tikzpicture}[
    node distance=1.5cm,
...
\begin{frame}{How ELIZA Works: High Level 🔧}
\begin{center}
\begin{tikzpicture}[
    node distance=1.2cm,
    box/.style={rectangle, draw, fill=blue!20, minimum width=2.5cm, minimum height=0.8cm, align=center, font=\small},
...
\begin{frame}{Pattern Priority and Ranking 🎯}
...
\begin{frame}{Breaking Down the Conversation 🔍}
...
\begin{frame}{Comparison: ELIZA vs Modern LLMs 📊}
\begin{center}
...
\begin{frame}{What You've Learned Today 🎓}
\begin{enumerate}
...
\begin{frame}{Next Lecture: Deep Dive into ELIZA 🔮}
