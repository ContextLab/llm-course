...
\begin{frame}{Complete ELIZA Flow with Memory 🔄}
\begin{center}
\begin{tikzpicture}[
    node distance=1.1cm,
    box/.style={rectangle, draw, fill=blue!20, minimum width=2.5cm, minimum height=0.7cm, align=center, font=\small},
    membox/.style={rectangle, draw, fill=green!20, minimum width=2cm, minimum height=0.7cm, align=center, font=\small},
...
\begin{frame}{Why the ELIZA Effect Happens 🧠}
\begin{center}
...
% Center
\node[font=\Large\bfseries] at (0,0) {ELIZA\\Effect};

% Surrounding factors
\node[align=center, font=\small] at (0,2.3) {\textbf{Anthropomorphization}\\We see humans everywhere};
\node[align=center, font=\small] at (2.3,1.3) {\textbf{Confirmation Bias}\\Remember hits,\\forget misses};
\node[align=center, font=\small] at (2.3,-1.3) {\textbf{Social Expectations}\\Respond as if human};
\node[align=center, font=\small] at (0,-2.3) {\textbf{Need for Connection}\\Lonely humans seek\\companionship};
\node[align=center, font=\small] at (-2.3,-1.3) {\textbf{Linguistic Cues}\\Language implies mind};
\node[align=center, font=\small] at (-2.3,1.3) {\textbf{Low Threshold}\\Easy to convince};

\end{tikzpicture}
\end{center}
\end{frame}

\begin{frame}{Weizenbaum's Reaction 😨}
...
\begin{frame}{The ELIZA Effect Today 📱}
...
\begin{frame}{Simulation vs. Understanding 🎭}
\begin{center}
...
% Examples below
\node[below, font=\small, align=center] at (0,-2.3) {ELIZA\\ChatGPT(?)};
\node[below, font=\small, align=center] at (6,-2.3) {Humans\\Animals(?)};
...
\begin{frame}{The Evolution of Chatbots 📈}
\begin{center}
...
\node[below, align=center, font=\small] at (1,-0.1) {ELIZA\\Pattern\\matching};

\node[above] at (3,0.1) {\textbf{1995}};
\node[below, align=center, font=\small] at (3,-0.1) {A.L.I.C.E.\\AIML};

\node[above] at (5,0.1) {\textbf{2001}};
\node[below, align=center, font=\small] at (5,-0.1) {SmarterChild\\Early IM bot};

\node[above] at (7,0.1) {\textbf{2011}};
\node[below, align=center, font=\small] at (7,-0.1) {Siri\\Voice\\assistant};

\node[above] at (9,0.1) {\textbf{2022}};
\node[below, align=center, font=\small] at (9,-0.1) {ChatGPT\\LLM};

\node[above] at (10.5,0.1) {\textbf{2024}};
\node[below, align=center, font=\small] at (10.5,-0.1) {GPT-4\\Claude\\Opus};
...
\begin{frame}{ELIZA vs Modern LLMs: Comparison 📊}
\begin{columns}
...
\begin{frame}{What ELIZA Teaches Us 🎓}
...
\begin{frame}{Assignment Structure 📋}
\begin{columns}
...
\begin{frame}{Extension Ideas (Optional) 🌟}
...
\begin{frame}{Resources for Learning 📚}
