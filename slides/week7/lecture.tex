...
\begin{frame}{What is Language Used For? 🎭}
    \begin{discussion}
...
\begin{frame}{Beyond Literal Meaning 🧩}
...
\begin{frame}{Visualizing Common Ground 🎯}
    \begin{center}
...
\begin{frame}{The Grounding Process 🏗️}
...
\begin{frame}{Embodied and Situated Language 🌍}
...
\begin{frame}{Why Embodiment Matters 🤖}
...
\begin{frame}{Comprehension is Inference 🔍}
...
\begin{frame}{Inference Construction Example 📖}
    \begin{block}{Text}
...
\begin{frame}{Embodied Language Processing 👁️}
...
\begin{frame}{Referential Ambiguity Resolution 🎯}
...
\begin{frame}{Visualizing Thought Trajectories 📊}
    \begin{center}
...
\begin{frame}{The Problem of Position 📍}
...
\begin{frame}{Visualizing Positional Encodings 📈}
    \begin{center}
        \begin{tikzpicture}[scale=0.8]
...
\begin{frame}{Context and Memory in Transformers 🧠}
...
\begin{frame}{Human vs. Transformer Memory 🔄}
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
...
\begin{frame}{Can Language Models Have Common Ground? 🤔}
    \begin{discussion}
...
\begin{frame}{Pragmatic Reasoning Example 🧩}
...
\begin{frame}{ConvoKit: Analyzing Real Conversations 🔬}
...
\begin{frame}{Using ConvoKit for Chatbot Evaluation 🤖}
