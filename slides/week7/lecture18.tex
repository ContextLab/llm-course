...
\begin{frame}{From BERT to GPT: Different Approaches 🔀}
    \begin{columns}[T]
...
\begin{frame}{The Transformer Decoder 🏗️}
...
\begin{frame}{Position Encoding in GPT 📍}
...
\begin{frame}{Two-Stage Training 🎓}
    \begin{center}
...
\begin{frame}{Pre-training: Language Modeling 📚}
...
\begin{frame}{Fine-tuning Implementation Details ⚙️}
...
\begin{frame}{Zero-Shot and Few-Shot Learning 🎯}
    \begin{discussion}
...
\begin{frame}{Visualizing What GPT Learns 🎨}
    \begin{center}
        \begin{tikzpicture}[scale=0.9]
...
\begin{frame}{The Generative Pre-training Paradigm 🌟}
...
\begin{frame}{Limitations of GPT-1 ⚠️}
