...
\begin{frame}{GPT-2: The Unexpected Leap 📈}
    \begin{discussion}
...
\begin{frame}{The WebText Dataset 🌐}
...
\begin{frame}{GPT-3's Emergent Abilities ✨}
    \begin{discussion}
...
\begin{frame}{The Scaling Laws Hypothesis 📈}
...
\begin{frame}{Implications of Scaling Laws 🎯}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \textbf{✅ Good news:}
            \begin{itemize}
...
\begin{frame}{The Path to ChatGPT 🤖}
    \begin{center}
        \begin{tikzpicture}[node distance=2cm]
            ...
            % Labels
            \node[below=0.3cm of gpt3, align=center, font=\small] {Predict\\next token};
            \node[below=0.3cm of instruct, align=center, font=\small] {Follow\\instructions};
            \node[below=0.3cm of chat, align=center, font=\small] {Helpful \&\\harmless};
        \end{tikzpicture}
    \end{center}
...
\begin{frame}{The Modern LLM Landscape 🌈}
