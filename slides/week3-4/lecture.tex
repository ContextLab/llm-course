...
% OVERVIEW
% ============================================================
\begin{frame}[shrink=10]{Overview 📋}
\large
...
% ============================================================
\begin{frame}[shrink=10]{Cognitive vs. Computational Perspectives 🧠💻}
\begin{columns}[T]
\begin{column}{0.48\textwidth}
...
% UMAP
% ============================================================
\begin{frame}[fragile,shrink=10]{UMAP: Uniform Manifold Approximation \& Projection 🗺️}
...
% LDA
% ============================================================
\begin{frame}[fragile,shrink=10]{Latent Dirichlet Allocation (LDA) 🎲}
...
% ============================================================
\begin{frame}[fragile,shrink=10]{Modern Topic Modeling 🎨}
...
% WORD2VEC INTRO
% ============================================================
\begin{frame}[shrink=10]{Word2Vec: The Revolution 🚀}
\begin{center}
\LARGE
...
% ============================================================
\begin{frame}[shrink=5]{Word2Vec Architectures 🏗️}
\begin{columns}[T]
\begin{column}{0.48\textwidth}
...
% GLOVE
% ============================================================
\begin{frame}[shrink=10]{GloVe: Global Vectors 🌍}
...
% FASTTEXT
% ============================================================
\begin{frame}[fragile,shrink=10]{FastText: Subword Information 🔤}
...
% ============================================================
\begin{frame}[fragile,shrink=5]{Visualizing Embeddings with UMAP 🎨}
\begin{columns}[T]
\begin{column}{0.48\textwidth}
...
% EVALUATION
% ============================================================
\begin{frame}[shrink=10]{How Do We Evaluate Embeddings? 📏}
\small
\begin{columns}[T]
\begin{column}{0.48\textwidth}
...
% LIMITATIONS
% ============================================================
\begin{frame}[shrink=10]{Limitations of Static Embeddings ⚠️}
...
% ============================================================
\begin{frame}[fragile]{Preview: Transformer Embeddings 🔮}
...
% ============================================================
\begin{frame}[shrink=10]{Discussion: How Do Humans Represent Meaning? 🤔}
\begin{center}
\Large
...
% PRACTICAL TIPS
% ============================================================
\begin{frame}[shrink=10]{Practical Tips for Using Embeddings 💡}
\begin{enumerate}\setlength{\itemsep}{0pt}
...
% ASSIGNMENT 3
% ============================================================
\begin{frame}[shrink=10]{Assignment 3: Exploring Text Embeddings ✍️}
