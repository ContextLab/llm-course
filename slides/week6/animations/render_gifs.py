#!/usr/bin/env python3
"""
Render all BERT animations as transparent looping GIFs.
...
# Scene names to render (must match class names in bert_scenes.py)
SCENES = [
    "BertVsGptAttention",
    "BertInputRepresentation",
    "SegmentEmbeddings",
...
def render_scene(scene_name: str) -> Path:
    ...
    for quality in ["1080p60", "1080p30", "1080p24", "720p30", "480p15"]:
        quality_dir = MEDIA_DIR / "videos" / "bert_scenes" / quality
...
def main():
    print("=" * 60)
    print("BERT Animation GIF Renderer")
    print("=" * 60)
