...
% BERT LIMITATIONS
% ============================================================
\begin{frame}{BERT's Limitations ⚠️}
...
% ROBERTA
% ============================================================
\begin{frame}{RoBERTa: Robustly Optimized BERT 🚀}
...
% ALBERT
% ============================================================
\begin{frame}{ALBERT: A Lite BERT 🔬}
...
% ALBERT COMPARISON
% ============================================================
\begin{frame}{ALBERT Parameter Efficiency 📊}
...
\begin{tikzpicture}[scale=0.6]
    \foreach \y/\label in {0/Layer 1, 1.5/Layer 2, 3/Layer 3} {
        ...
        \node[right=0.2cm of {(1.5, \y)}] {\tiny Different weights};
    }
...
\begin{center}
\begin{tikzpicture}[scale=0.6]
    \node[rectangle,draw,fill=green!30,minimum width=3cm,minimum height=1cm] (shared) at (3, 1.5) {Shared\\Parameters};
...
% DISTILBERT
% ============================================================
\begin{frame}{DistilBERT: Knowledge Distillation ⚡}
...
% ELECTRA
% ============================================================
\begin{frame}{ELECTRA: Efficient Learning 🔌}
...
% OTHER VARIANTS
% ============================================================
\begin{frame}{Other Notable BERT Variants 🌟}
