...
% WHY BERT
% ============================================================
\begin{frame}[shrink=10]{Why BERT Was Revolutionary 🚀}
...
% MLM EXAMPLE
% ============================================================
\begin{frame}[shrink=10]{MLM Example: Step by Step 📝}
...
% BERT INPUT
% ============================================================
\begin{frame}[shrink=5]{BERT Input Representation 🔤}
...
% PRE-TRAINING
% ============================================================
\begin{frame}[shrink=10]{BERT Pre-training 🏋️}
\small
...
% FINE-TUNING
% ============================================================
\begin{frame}[shrink=5]{Fine-tuning BERT 🎓}
...
% FINE-TUNING TASKS
% ============================================================
\begin{frame}[shrink=10]{Fine-tuning for Different Tasks 🎯}
...
% WHAT BERT LEARNS
% ============================================================
\begin{frame}[shrink=10]{What Does BERT Learn? 🧠}
...
% LAYER ANALYSIS
% ============================================================
\begin{frame}[shrink=5]{BERT Layer Analysis 📊}
