...
% ============================================================
\begin{frame}[shrink=10]{From Count-Based to Prediction-Based 🎯}
\begin{columns}[T]
...
% CBOW
% ============================================================
\begin{frame}[shrink=10]{CBOW: Continuous Bag of Words 🎒}
...
\begin{tikzpicture}[scale=0.8]
    ...
    % Labels
    \node[font=\footnotesize] at (-3.5, 4.5) {Input:};
    \node[font=\footnotesize] at (-3.5, 2.15) {Hidden:};
    \node[font=\footnotesize] at (-3.5, 0.5) {Output:};
\end{tikzpicture}
\end{center}
\end{column}
...
% SKIP-GRAM
% ============================================================
\begin{frame}[shrink=10]{Skip-gram: The Inverse Approach 🔄}
...
% GLOVE VS WORD2VEC
% ============================================================
\begin{frame}[shrink=10]{GloVe vs. Word2Vec 🥊}
\small
\begin{columns}[T]
\begin{column}{0.48\textwidth}
...
% FASTTEXT INTRO
% ============================================================
\begin{frame}[shrink=10]{FastText: Enriching with Subword Information 🔤}
...
% EVALUATION
% ============================================================
\begin{frame}[shrink=10]{Evaluating Word Embeddings 📏}
\begin{columns}[T]
\begin{column}{0.48\textwidth}
...
% BIASES
% ============================================================
\begin{frame}[shrink=10]{Bias in Word Embeddings ⚖️}
...
% DEBIASING
% ============================================================
\begin{frame}[shrink=10]{Debiasing Approaches 🔧}
...
% APPLICATIONS
% ============================================================
\begin{frame}[shrink=10]{Real-World Applications 🌟}
\begin{columns}[T]
\begin{column}{0.48\textwidth}
