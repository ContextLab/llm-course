#!/usr/bin/env python3
"""
Render all transformer animations as transparent looping GIFs.
...
def render_scene(scene_name: str) -> Path:
    ...
    for quality in ["1080p60", "1080p30", "1080p24", "720p30", "480p15"]:
        quality_dir = MEDIA_DIR / "videos" / "transformer_scenes" / quality
...
def main():
    print("=" * 60)
    print("Transformer Animation GIF Renderer")
    print("=" * 60)
