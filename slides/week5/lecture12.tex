...
% ============================================================
\begin{frame}[shrink=10]{Encoder-Decoder Architecture 🏗️}
...
% ATTENTION TYPES
% ============================================================
\begin{frame}[shrink=10]{Attention Score Functions 📐}
...
% ATTENTION BENEFITS
% ============================================================
\begin{frame}[shrink=10]{Benefits of Attention Mechanisms ✅}
\begin{enumerate}\setlength{\itemsep}{0pt}
...
% REAL WORLD IMPACT
% ============================================================
\begin{frame}[shrink=10]{Real-World Impact of Attention 🌍}
\small
