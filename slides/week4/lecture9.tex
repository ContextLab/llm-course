...
% ============================================================
\begin{frame}[shrink=5]{The Polysemy Problem Revisited 🤔}
...
% LANGUAGE MODELS
% ============================================================
\begin{frame}[shrink=10]{Language Models as Feature Extractors 🧬}
...
\begin{tikzpicture}[scale=0.7]
    ...
    \foreach \x/\word in {0/cat, 1.5/sat, 3/on, 4.5/the}
        \node[font=\footnotesize] at (\x, 0.8) {\word};
...
% ELMO INTRO
% ============================================================
\begin{frame}[shrink=10]{ELMo: Embeddings from Language Models 🔮}
...
\begin{tikzpicture}[scale=0.6]
    ...
    \node[font=\footnotesize] at (0, 4.85) {ELMo};
...
% ELMO DETAILS
% ============================================================
\begin{frame}[shrink=10]{ELMo: How It Works 🔍}
\textbf{Training:}
...
% ============================================================
\begin{frame}[shrink=10]{Universal Sentence Encoder (USE) 🌐}
...
% BERT INTRO
% ============================================================
\begin{frame}[shrink=10]{BERT: Bidirectional Encoder Representations 🎭}
\begin{center}
\LARGE
...
% MASKED LM
% ============================================================
\begin{frame}[shrink=10]{Masked Language Modeling (MLM) 🎭}
...
% BERT ARCHITECTURE
% ============================================================
\begin{frame}[shrink=5]{BERT Architecture 🏗️}
\begin{center}
\begin{tikzpicture}[scale=0.7]
    % Input
    \node at (-3, 0) {Input:};
    \foreach \x/\word in {0/[CLS], 1.5/The, 3/cat, 4.5/[MASK], 6/on, 7.5/mat, 9/[SEP]}
        \node[font=\footnotesize] at (\x, 0) {\word};
    ...
    % Task heads
    \draw[->] (0, 8) -- (0, 8.5);
    \node[font=\footnotesize] at (0, 9) {Classification};

    \draw[->] (4.5, 8) -- (4.5, 8.5);
    \node[font=\footnotesize] at (4.5, 9) {Predict: sat};
\end{tikzpicture}
\end{center}
\end{frame}
...
% IMPACT
% ============================================================
\begin{frame}[shrink=10]{Impact on NLP 🌟}
