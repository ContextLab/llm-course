...
\begin{frame}{The Limits of Parametric Memory 🧠}
\begin{discussionbox}
...
\begin{frame}{RAG Architecture 🏗️}
\begin{center}
\begin{tikzpicture}[
    node distance=1.5cm,
...
\begin{frame}{Advanced RAG Techniques 🚀}
\begin{columns}[T]
...
\begin{frame}{RAG Components Deep Dive 🔬}
\begin{enumerate}
...
\begin{frame}{MoE Architecture 🏗️}
\begin{center}
\begin{tikzpicture}[
    node distance=1.2cm,
...
% Formula
\node[below=0.3cm of input, font=\small] {$y = \sum_{i=1}^{N} g(x)_i \cdot E_i(x)$};
...
\begin{frame}{How MoE Works: The Router 🎯}
...
\begin{frame}{MoE Challenges \& Solutions ⚠️}
\begin{columns}[T]
\begin{column}{0.48\textwidth}
\textbf{Challenges:}
\begin{enumerate}
...
\begin{frame}{MoE vs Dense Models 📊}
\begin{center}
\begin{tikzpicture}
    \begin{axis}[
        width=0.9\textwidth,
...
\begin{tikzpicture}[
    ...
    anchor/.style={rectangle, draw, fill=green!40, minimum size=1cm},
    pos/.style={rectangle, draw, fill=green!20, minimum size=1cm},
    neg/.style={rectangle, draw, fill=red!20, minimum size=1cm}
]
...
% Positive
\node[pos, right=2cm of anchor] (pos) {🐕};
\node[below=0.1cm of pos, font=\tiny] {Positive};

% Negatives
\node[neg, above right=0.5cm and 3.5cm of anchor] (neg1) {🐱};
\node[neg, right=3.5cm of anchor] (neg2) {🚗};
\node[neg, below right=0.5cm and 3.5cm of anchor] (neg3) {🌳};

% Arrows
\draw[->, thick, green!60!black] (anchor) -- (pos) node[midway, above, font=\small] {Pull together};
...
\begin{frame}{SimCLR: Simple Contrastive Learning 🔬}
...
\begin{frame}{CLIP: Connecting Vision \& Language 🖼️📝}
...
% Similarity matrix
\node[above=2cm of imgemb, font=\small] (matrix) {
\begin{tabular}{c|ccc}
    & $T_1$ & $T_2$ & $T_3$ \\
\hline
$I_1$ & ✓ & × & × \\
...
\begin{frame}{CLIP Training \& Applications 🎨}
...
\begin{frame}{Current State of LLMs 📍}
...
\begin{frame}{Future Direction 1: Multimodality 🎨🔊}
\begin{futurebox}
...
\begin{frame}{Future Direction 2: Reasoning \& Planning 🧠}
\begin{futurebox}
...
\begin{frame}{Future Direction 3: Agents \& Autonomy 🤖}
\begin{futurebox}
...
\begin{frame}{Future Direction 4: Efficiency \& Sustainability 🌱}
\begin{futurebox}
...
\begin{frame}{Future Direction 5: Personalization \& Memory 💾}
\begin{futurebox}
...
\begin{frame}{Speculative: What Could Go Wrong? ⚠️}
\begin{columns}[T]
\begin{column}{0.48\textwidth}
...
\begin{frame}{Project Ideas: RAG Applications 🔍}
...
\begin{frame}{Project Ideas: Model Architectures 🏗️}
...
\begin{frame}{Project Ideas: Reasoning \& Agents 🤖}
...
\begin{frame}{Project Ideas: Multimodal \& Creative 🎨}
...
\begin{frame}{Project Ideas: Analysis \& Safety 🔬}
...
\begin{frame}{Making Your Project Stand Out 🌟}
\begin{enumerate}
...
\begin{frame}{Proposal Requirements 📝}
