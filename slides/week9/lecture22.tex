...
\begin{frame}{Dense vs Sparse Models 🎯}
\begin{columns}[T]
...
\begin{frame}{What is Mixture of Experts? 🧠}
...
\begin{frame}{Load Balancing Solutions 🔧}
...
\begin{frame}{Training Instability ⚠️}
...
\begin{frame}{Memory and Communication 💾}
...
\begin{frame}{What Do Experts Learn? 🔬}
...
\begin{frame}{Model Compression Methods 🗜️}
...
\begin{frame}{Inference Optimizations ⚡}
...
\begin{frame}{State Space Models: Mamba 🐍}
...
\begin{frame}{Efficiency Trade-off Landscape 🗺️}
\begin{center}
\begin{tikzpicture}
    \begin{axis}[
        width=0.9\textwidth,
...
\begin{frame}{Democratizing Access 🔓}
\begin{discussionbox}
...
\begin{frame}{Open vs Closed Models 🤔}
\begin{columns}[T]
\begin{column}{0.48\textwidth}
...
\begin{frame}{Future of Efficient LLMs 🔮}
