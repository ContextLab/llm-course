...
const criticalTests = [
    ...
    { test: 'DEFLECTION MOTIVES', input: 'Why do you say that?', expected: 'motive|getting' },
    { test: 'PEOPLE ON NERVES', input: 'How do people make you feel?', expected: 'nerve|bother' },
    ...
    { test: 'TRUST QUESTION', input: 'Do you trust people?', expected: 'trust|stranger|betray|confide' },
